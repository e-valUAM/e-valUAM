<?php
	...
	if (isset($_REQUEST['nombre'])) {
		...
		$result = pg_query_params($con,
			'INSERT INTO examenes (nombre, disponible, duracion, id_materia, num_preguntas, num_por_nodo, mostrar_resultados, acepta_duda) VALUES ($1, $2, $3, $4, $5, 1, $6, $7);',
			array($_REQUEST['nombre'], $disponible, intval($_REQUEST['duracion']), intval($_REQUEST['idMateria']), intval($_REQUEST['numPreguntas']), $_REQUEST['mostrarResultados'], $duda));
